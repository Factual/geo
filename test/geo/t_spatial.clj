...
(facts "interchangeable points"
       (let [g->s (comp s/to-spatial4j-point s/to-geohash-point)
             ...
             j->s (comp s/to-spatial4j-point s/to-jts-point)
             s->j (comp s/to-jts-point s/to-spatial4j-point)
             j->g (comp s/to-geohash-point s/to-jts-point)
             g->j (comp s/to-jts-point s/to-geohash-point)
             ...
             c1 (jts/coordinate 0 0)
             c2 (jts/coordinate -98.765 12.456)]
         ; Identity conversions
         (fact (s/to-geohash-point g2) g2)
         (fact (s/to-spatial4j-point g2) s2)
         (fact (s/to-jts-point j2) j2)

         ; Direct conversions
         (fact (s/to-spatial4j-point g2) s2)
         (fact (s/to-spatial4j-point j2) s2)
         (fact (s/to-spatial4j-point c2) s2)
         (fact (s/to-geohash-point s2) g2)
         (fact (s/to-geohash-point j2) g2)
         (fact (s/to-geohash-point c2) g2)
         (fact (s/to-jts-point s2) j2)
         (fact (s/to-jts-point g2) j2)
         (fact (s/to-jts-point c2) j2)
